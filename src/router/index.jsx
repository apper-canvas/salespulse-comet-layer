...
const mainRoutes = [
  ...
  {
    path: "deals", 
    element: <Suspense fallback={suspenseFallback}><Deals /></Suspense>
  },
  {
    path: "tasks",
    element: <Suspense fallback={suspenseFallback}><Tasks /></Suspense>
  },
  {
    path: "reports",
...
const routes = [
  ...
  {
    path: "/landing",
    element: <Suspense fallback={suspenseFallback}><LandingPage /></Suspense>
  }
];
